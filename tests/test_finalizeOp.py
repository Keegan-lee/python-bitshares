...
from gravity.utils import parse_time
...
from gravitybase import operations
...
test_operation_dicts = [
    {'active': {'account_auths': [],
                'address_auths': [],
                'key_auths': [['ZGV7oA1zCmmK3JWP7uNbJ2Z6Fe8G7fjWos7T6ih2WC3iAvGfMVaYD',
                               1]],
                'weight_threshold': 1},
     ...
     'options': {'extensions': [],
                 'memo_key': 'ZGV8R3ZAd6AtQDQK9cin6fHEw9uKUwzzxLbo2w6X1aKC5Wtir8iND',
                 'num_committee': 0,
                 'num_witness': 0,
                 'votes': [],
     ...
     'owner': {'account_auths': [],
               'address_auths': [],
               'key_auths': [['ZGV8Y6f9GoaLnSmLhF8FDSc5YijLddD8ThwdEwGaNGBdCMDD8o7zF',
                              1]],
               'weight_threshold': 1},
